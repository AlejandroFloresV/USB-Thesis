...
Con la finalidad de analizar los resultados de la sección \ref{sec-res}, e identificar las mejores estrategias de inicialización o las mejores metaheurísticas (según corresponda), se presentan dos estilos de tablas que muestran información complementaria.

En primer lugar, se presenta una tabla con los resultados promedio de cada metaheurística o inicialización evaluada, en función de los 4 criterios de comparación descritos en la subsección \ref{sec-parametros}. Al comparar diferentes estrategias de inicialización, se promedian las métricas obtenidas por las 5 metaheurísticas frente a los conjuntos de datos que correspondan; por ejemplo, los resultados de una inicialización usando $\delta = 50\%$ son los promedios de los resultados de GGA, SGA, CHC, PBIL y PSO al usar los conjuntos de datos grandes. Similarmente, al comparar entre metaheurísticas se promedian los resultados obtenidos por un algoritmo particular (por ejemplo, PBIL) para los conjuntos de datos que correspondan.

Sin embargo, al promediar los resultados puede perderse información relevante. El efecto de una estrategia de inicialización puede variar para diferentes algoritmos, y el comportamiento de una metaheurística depende a su vez del conjunto de datos que se use para evaluarla. Por esta razón, se introducen las tablas de ranking, que presentan información adicional que permite comparar las inicializaciones o metaheurísticas bajo un mismo contexto. En función de una métrica particular, las estrategias de inicialización son ordenadas en función de sus resultados por cada algoritmo en cada conjunto de datos, y las metaheurísticas son ordenadas en función a sus resultados en cada conjunto de datos. Las tablas de ranking muestran el ranking promedio de cada inicialización/metaheurística y el número de veces que logró el mejor resultado.
